...
%
addpath('C:\Users\Heinz Lab - NEL2\Desktop\ABRanalysis\ABR-master\Matlab_ABR\ABR_analysis'); 
...
if nargin < 1
	...
	dp_FIG.push.copy_dps = uicontrol(dp_FIG.handle,'callback','dp_analysis(''copy_dps'');','style','pushbutton',...
		'Units','normalized','position',[0.44 0.05 0.1 .03],'string','Copy DP data');
...
elseif strcmp(command_str,'save_dps') & strcmp(get(han_dp.dp_curve,'Box'),'on')
	save_dps
elseif strcmp(command_str,'copy_dps') & strcmp(get(han_dp.dp_curve,'Box'),'on')
	copy_dps
